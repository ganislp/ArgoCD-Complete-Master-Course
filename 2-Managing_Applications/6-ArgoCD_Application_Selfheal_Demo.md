...
[0-Demo_Files/Nginx_Deployment/nginx-deployment.yaml](https://github.com/ganislp/ArgoCD-Complete-Master-Course/blob/main/0-Demo_Files/Nginx_Deployment/nginx-deployment.yaml)
